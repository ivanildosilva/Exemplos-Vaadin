...
/**
 * Encapsula o acesso �s funcionalidades de video.
 * Essa classe atua como um Facade para o framework JMF
 *  
 * @author silvio
 *
 */
		...
		for (Object dispositivo : list) { //iteramos todos os dispositivos
			...
			//caso seja um dispositivo de video retornamos o primeiro encontrado
			 if ( nome.startsWith ("v") ) 
				 /* 
				  * Verificamos se a informacao do dispositivo inicia-se com v, essa verifica��o permite que funcione tanto no linux quanto no windows
				  * No linux os dispositivos recebem o nome : "v4l://0"
				  * enquanto no windows : "vfw://0"  
				  */ 
			 {
				 return device;
			 }
