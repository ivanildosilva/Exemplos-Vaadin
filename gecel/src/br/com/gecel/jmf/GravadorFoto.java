...
import br.com.gecel.view.CadastroAluno;
...
public class GravadorFoto {
    ...
    public synchronized void salvarFoto() throws Exception {
        ...
        String nomeArquivo = CadastroAluno.txtmatricula.getText().concat(".jpg");
        System.out.println("caminho foto " + nomeArquivo);
...
// 	private String getNomeArquivo(String foto){
//            
//            
...
// 	}
    private void salvarParteDaFoto(BufferedImage imagemOriginal, String nomeArquivo, int x, int y, int largura, int altura) throws Exception {
        ...
        ImageIO.write(imagemCortada, "jpg", new File("C:/Arquivos de programas/Fotos/".concat(nomeArquivo)));
